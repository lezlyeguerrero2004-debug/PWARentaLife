...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    // Hashear la contraseña como SHA2-256 para comparar
    // Esto genera exactamente lo mismo que usaste en el INSERT
    ...
    if (mysqli_num_rows($resultado) > 0) {
        ...
        $_SESSION["foto"] = $row["foto_perfil"]; //mostrar foto de perfil
